import Image from "next/image"; // BAGONG IMPORT
...
export default function About() {
  ...
  return (
    <section id="about" className="min-h-screen flex flex-col justify-center py-24 border-t border-gray-200/60 relative">
      ...
      {/* INI-ADJUST ANG MAX-WIDTH PARA SA 2 COLUMNS */}
      <div className="max-w-6xl mx-auto px-6 w-full relative z-10">
        
        {/* GRID LAYOUT: Stacked sa mobile, Side-by-side sa desktop */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-20 items-center">
          
          {/* --- LEFT COLUMN: LARAWAN --- */}
          <div className="md:col-span-5 flex justify-center md:justify-start">
            <div className="relative group">
              {/* Blue decorative glow behind image */}
              ...
              <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-white shadow-2xl shadow-blue-500/20 ring-4 ring-blue-100/50">
                <Image
                  src="/me.jpg" // <-- Siguraduhing tama ang filename sa public folder
                  alt="Edward Layno"
                  fill
                  priority // Mas mabilis mag-load
          ...
          <div className="md:col-span-7">
            ...
            <p className="text-blue-600 font-semibold mb-8 text-lg">Full-Stack Developer & IT Student</p>
            
            <div className="prose prose-lg text-gray-600 space-y-6 leading-relaxed max-w-none">
              <p>
                I am a 4th-year <strong className="text-gray-800">Information Technology</strong> student with a strong passion for building scalable and user-friendly web applications. I enjoy bridging the gap between elegant frontend interfaces and robust backend architectures.
              </p>
              <p>
                Beyond writing code, I have experience in network administration, server management (Ubuntu), and automated quality assurance testing. I'm always looking for ways to optimize workflows and build secure systems.
              </p>
            </div>
